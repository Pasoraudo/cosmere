...
/**
 *  If a message belongs to our accounts, it's marked by setting it as
 *  'me'. If it belongs to the accounts we are chatting with, then it
...
export const messages = [
    ...
    },
    {
        ...
        chatId   : '',
        contactId: 'me',
        value    : 'You know I got a job in that big software companyClient. First move was because of that.',
