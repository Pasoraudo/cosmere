...
export const Legend = ({// @ts-ignore
                  ...
                  marginBottom = 20,
                  marginLeft = 5,
                  ticks = height / 64,// @ts-ignore
                  tickFormat,// @ts-ignore
                  tickValues
                } = {}) => {
  ...
  if (color.interpolate) {
    ...
    svg.append("image")
      ...
      .attr("preserveAspectRatio", "none")// @ts-ignore
  ...
  // Threshold
    ...
    svg.append("g")
      ...
      .attr("width", width - marginRight - marginLeft)// @ts-ignore
      .attr("fill", d => d);
